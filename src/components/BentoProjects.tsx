...
const projects = [
  ...
  },
  {
    ...
    description: 'AI-powered lead automation pipeline that captures prospect data, enriches it, generates a personalized PDF report using Claude AI, and delivers it via email.',
    tags: ['Python', 'AI', 'Automation'],
    image: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=600&h=400&fit=crop',
    size: 'medium',
    color: 'from-emerald-500/20 to-teal-500/20',
    github: 'https://github.com/Lalith9701/lead-automation-system',
  },
  {
    id: 5,
    title: 'Blood Bank Management System',
    description: 'Django-based web application to manage blood inventory, donors, and recipient requests efficiently.',
    tags: ['Django', 'Python', 'Web Development'],
    image: 'https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=600&h=400&fit=crop',
    size: 'medium',
    color: 'from-red-500/20 to-rose-500/20',
    github: 'https://github.com/Lalith9701/BloodBank_Django_Project',
  },
  {
    id: 6,
    title: 'Binance Trading Bot',
    description: 'Automated cryptocurrency trading bot integrated with the Binance testnet for backtesting and executing strategies.',
    tags: ['Python', 'Binance API', 'Trading'],
    image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=600&h=400&fit=crop',
    size: 'medium',
    color: 'from-yellow-500/20 to-amber-500/20',
    github: 'https://github.com/Lalith9701/trading-bot-binance-testnet',
  },
  {
    id: 4,
